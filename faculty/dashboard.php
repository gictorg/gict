...
try {
    ...
    $coursesSql = "SELECT COUNT(*) as count FROM faculty_courses WHERE faculty_id = ? AND status = 'active'";
    $coursesResult = getRow($coursesSql, [$user_id]);
    $stats['total_courses'] = $coursesResult['count'] ?? 0;

    // Get total students enrolled in courses assigned to this faculty
    $studentsSql = "SELECT COUNT(DISTINCT se.user_id) as count 
                    FROM student_enrollments se 
                    JOIN faculty_courses fc ON se.sub_course_id = fc.sub_course_id
                    WHERE fc.faculty_id = ? AND se.status = 'enrolled'";
    $studentsResult = getRow($studentsSql, [$user_id]);
    $stats['total_students'] = $studentsResult['count'] ?? 0;

    // Get active assignments
    $assignmentsSql = "SELECT COUNT(*) as count FROM assignments WHERE created_by = ? AND status = 'active'";
    $assignmentsResult = getRow($assignmentsSql, [$user_id]);
    $stats['active_assignments'] = $assignmentsResult['count'] ?? 0;

    // Get pending submissions to grade
    $pendingGradingSql = "SELECT COUNT(*) as count 
                          FROM assignment_submissions asub
                          JOIN assignments a ON asub.assignment_id = a.id
                          WHERE a.created_by = ? AND asub.status = 'submitted'";
    $pendingGradingResult = getRow($pendingGradingSql, [$user_id]);
    $stats['pending_grading'] = $pendingGradingResult['count'] ?? 0;
    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar">
            ...
            <div class="profile-card-mini">
                <img src="../assets/images/default-faculty.png" alt="Profile"
        ...
        <main class="admin-content">
            ...
            <div class="faculty-stats">
                ...
                <div class="stat-card warning">
                    <h3><?php echo $stats['active_assignments'] ?? 0; ?></h3>
                    <p>Active Assignments</p>
                </div>
                <div class="stat-card info">
                    <h3><?php echo $stats['pending_grading'] ?? 0; ?></h3>
                    <p>Pending Grading</p>
                </div>
            </div>
            ...
            <div class="quick-actions">
                ...
                <div class="action-card" onclick="window.location.href='assignments.php'">
                                ...
                                <div class="course-card">
                                    ...
                                    <div class="course-info">
                                        <div class="info-item">
                                            ...
                                            <span
                                                class="info-value"><?php echo htmlspecialchars($course['category_name'] ?? 'General'); ?></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Duration</span>
                                            <span
                                                class="info-value"><?php echo htmlspecialchars($course['duration'] ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Fee</span>
                                            <span
                                                class="info-value">₹<?php echo number_format($course['fee'] ?? 0, 2); ?></span>
                                        </div>
                                        <div class="info-item">
                                    ...
                                    <div style="margin-top: 15px;">
                                        <button class="btn btn-primary"
                                            onclick="viewCourseDetails(<?php echo $course['id']; ?>)">
                                            <i class="fas fa-eye"></i> View Details
                                        </button>
                                        <button class="btn btn-secondary"
                                            onclick="manageStudents(<?php echo $course['id']; ?>)">
                ...
                <div class="panel-body">
                    <div class="attendance-info">
                        ...
                        <a href="attendance.php" class="btn btn-primary">
                            <i class="fas fa-calendar-check"></i> Take Attendance Now
                        </a>
                    </div>
                </div>
            </div>
