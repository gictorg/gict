-- Create GICT Franchise Database
-- This script creates a new database named 'gict_franchise' with all franchise model tables

-- Create the database
CREATE DATABASE IF NOT EXISTS gict_franchise CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
SELECT 'GICT Franchise Database created successfully!' as message;
SELECT 'Database Name: gict_franchise' as info;
SELECT 'Tables Created: 7' as tables;
