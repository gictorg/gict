        ...
        <div class="admin-layout">
            <aside class="admin-sidebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li><a href="admin/marks-management.php"><i class="fas fa-chart-line"></i> Marks Management</a></li>
                    <li><a href="admin/certificate-management.php"><i class="fas fa-certificate"></i> Certificate
                            Management</a></li>
            ...
            <main class="admin-content">
                <div class="widget-row">
                    <section class="panel certificate-card">
                        <div class="panel-header">Authorization Certificate <a
                                style="font-size:12px; font-weight:500; text-decoration:none; margin-left:auto; color:#fff;"
                                href="assets/certificates/authorization-certificate.html" target="_blank"><i
                                    class="fas fa-download"></i> View Certificate</a></div>
                ...
                <div class="grid-3">
                    ...
                    <?php if ($userType === 'admin'): ?>
                        <section class="panel system-overview-card"
                            onclick="window.open('PRD_Visualization_Dashboard.php', '_blank')"
                            style="cursor: pointer; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 12px; padding: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; grid-column: span 3; margin-top: 20px;">
                            <i class="fas fa-project-diagram" style="font-size: 40px; margin-bottom: 15px;"></i>
                            <h3 style="color: white; margin: 0 0 10px 0;">System Overview</h3>
                            <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 14px;">Explore comprehensive system
                                architecture, requirements, and feature documentation</p>
                        </section>
                    <?php endif; ?>
                </div>
