        ...
        <main class="admin-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>Active Staff</h3>
                    <div class="value">
                        <?php echo count(array_filter($staff, function ($s) {
            ...
            <div class="search-section">
                <div class="search-box">
                    ...
                    <input type="text" id="staffSearch" placeholder="Search staff by name, user ID, email, or phone..."
                        onkeyup="searchStaff()">
                    <button class="clear-search" onclick="clearStaffSearch()" id="clearStaffSearchBtn"
                        style="display: none;">
                ...
                <?php foreach ($staff as $member): ?>
                    <div class="staff-card">
                        ...
                        <div class="staff-info">
                            ...
                            <?php echo htmlspecialchars(ucfirst($member['gender'] ?? 'N/A')); ?><br>
                        ...
                        <div class="qualification-section">
                            ...
                            <div class="staff-info">
                                ...
                                <?php echo htmlspecialchars($member['qualification'] ?? 'N/A'); ?><br>
                                <strong>Experience:</strong> <?php echo $member['experience_years']; ?> years<br>
                                <strong>Joining Date:</strong>
                                <?php echo $member['joining_date'] ? date('M d, Y', strtotime($member['joining_date'])) : 'N/A'; ?>
                            </div>
                        </div>
                        ...
                        <div class="staff-actions">
                            ...
                            <button class="btn btn-password"
                                onclick="openPasswordModal(<?php echo $member['id']; ?>, '<?php echo htmlspecialchars($member['username']); ?>')">
                                <i class="fas fa-key"></i> Password
                            </button>
                            <button class="btn btn-toggle"
                                onclick="toggleStatus(<?php echo $member['id']; ?>, '<?php echo $member['status'] === 'active' ? 'inactive' : 'active'; ?>')">
                                <i class="fas fa-toggle-on"></i>
                                <?php echo $member['status'] === 'active' ? 'Deactivate' : 'Activate'; ?>
                            </button>
                            <button class="btn btn-delete"
                                onclick="deleteStaff(<?php echo $member['id']; ?>, '<?php echo htmlspecialchars($member['full_name']); ?>')">
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper">
                            <input type="file" id="profile_image" name="profile_image" accept="image/*"
                                onchange="previewImage(this, 'staff-profile-preview')">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="staff.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="new_password" name="staff_password" required minlength="6"
