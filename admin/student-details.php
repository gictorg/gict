...
<head>
    ...
    <style>
        ...
        .enrollment-card .info-grid {
            gap: 15px;
            grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));
        }

        .enrollment-card .info-item {
            padding: 12px 16px;
            border-radius: 12px;
        }
        ...
        .enrollment-card:hover {
            box-shadow: 0 20px 40px rgba(0, 110, 255, 0.05);
            border-color: #667eea;
...
<body class="admin-dashboard-body">
    <div class="admin-layout">
        <aside class="admin-sidebar shadow-premium">
            ...
            <div class="profile-card-mini">
                ...
                <div class="profile-info">
                    ...
                    <div class="role"><?php echo htmlspecialchars(ucfirst($user['type'] ?? 'Admin')); ?></div>
                </div>
            </div>
            <ul class="sidebar-nav">
                <li><a href="../index.php"><i class="fas fa-home"></i> <span>Home</span></a></li>
                <li><a href="../dashboard.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                <li><a class="active" href="students.php"><i class="fas fa-user-graduate"></i> <span>Students</span></a>
                </li>
                <li><a href="staff.php"><i class="fas fa-user-tie"></i> <span>Staff</span></a></li>
                <li><a href="courses.php"><i class="fas fa-graduation-cap"></i> <span>Courses</span></a></li>
                <li><a href="marks-management.php"><i class="fas fa-chart-line"></i> <span>Marks Management</span></a>
                </li>
                <li><a href="certificate-management.php"><i class="fas fa-certificate"></i> <span>Certificate
                            Management</span></a></li>
                <li><a href="payments.php"><i class="fas fa-credit-card"></i> <span>Payments</span></a></li>
                <li><a href="inquiries.php"><i class="fas fa-question-circle"></i> <span>Course Inquiries</span></a>
                </li>
        ...
        <main class="admin-content">
            ...
            <div class="student-detail-header">
                <div style="position: relative; display: inline-block;">
                    <img src="<?php echo !empty($student['profile_image']) ? htmlspecialchars($student['profile_image']) : '../assets/images/default-student.png'; ?>"
                        alt="Profile" class="student-avatar-large" id="profile-image-preview"
                        onerror="this.src='../assets/images/default-student.png'">
                    <button onclick="document.getElementById('profile-image-upload').click()" class="btn btn-primary"
                    ...
                    <input type="file" id="profile-image-upload" name="document_file" accept="image/*"
                        style="display: none;" onchange="showUploadForm('profile', this)">
                </div>
                <div class="student-header-info">
                    ...
                    <p><i class="fas fa-phone-alt"></i> <?php echo htmlspecialchars($student['phone'] ?? 'N/A'); ?></p>
                    <?php if (!empty($enrollments)): ?>
                        <div style="margin-top: 15px;">
                            <a href="../id.php?student_id=<?php echo $student['id']; ?>" target="_blank"
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            <?php echo $student['date_of_birth'] ? date('d M Y', strtotime($student['date_of_birth'])) : 'N/A'; ?>
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Gender</div>
                        <div class="info-value"><?php echo htmlspecialchars(ucfirst($student['gender'] ?? 'N/A')); ?>
                        </div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            <?php echo $student['joining_date'] ? date('d M Y', strtotime($student['joining_date'])) : 'N/A'; ?>
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Qualification</div>
                        <div class="info-value"><?php echo htmlspecialchars($student['qualification'] ?? 'N/A'); ?>
                        </div>
                    </div>
                    <div class="info-item">
                        ...
                        <div class="enrollment-card">
                            <div class="enrollment-header">
                                <div>
                                    <h3 class="enrollment-title">
                                        <?php echo htmlspecialchars($enrollment['course_name'] ?? 'N/A'); ?>
                                    </h3>
                                    <?php if (!empty($enrollment['sub_course_name'])): ?>
                                        <p style="color: #666; margin: 5px 0;"><i class="fas fa-book"></i>
                                            <?php echo htmlspecialchars($enrollment['sub_course_name']); ?></p>
                                    <?php endif; ?>
                                    <?php if (!empty($enrollment['category_name'])): ?>
                                        <p style="color: #666; margin: 5px 0;"><i class="fas fa-tag"></i>
                                            <?php echo htmlspecialchars($enrollment['category_name']); ?></p>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="info-grid" style="margin-top: 15px;">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo $enrollment['enrollment_date_formatted'] ?? 'N/A'; ?>
                                    </div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value">
                                        <?php echo htmlspecialchars($enrollment['course_duration'] ?? 'N/A'); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php if (!empty($enrollment['total_fee'])): ?>
                                <div class="fees-summary">
                                    ...
                                    <div class="fee-item paid">
                                        ...
                                        <div class="fee-value" style="color: #28a745;">
                                            ₹<?php echo number_format($enrollment['paid_fees'] ?? 0, 2); ?></div>
                                    </div>
                                    <div class="fee-item remaining">
                                        <div class="fee-label">Remaining</div>
                                        <div class="fee-value"
                                            style="color: <?php echo ($enrollment['remaining_fees'] ?? 0) > 0 ? '#dc3545' : '#28a745'; ?>;">
                                ...
                                <div style="display: flex; gap: 10px; margin-top: 15px; flex-wrap: wrap;">
                                    <button class="btn btn-primary"
                                        onclick="editFees(<?php echo $enrollment['id']; ?>, <?php echo $enrollment['total_fee']; ?>, <?php echo $enrollment['paid_fees'] ?? 0; ?>)">
                                        <i class="fas fa-edit"></i> Edit Fees
                                    </button>
                                    <button class="btn btn-info"
                                        onclick="editStatus(<?php echo $enrollment['id']; ?>, '<?php echo $enrollment['enrollment_status']; ?>')">
                                        <i class="fas fa-exchange-alt"></i> Change Status
                                    </button>
                                    <a href="marks-management.php?enrollment_id=<?php echo $enrollment['id']; ?>"
            ...
            <div class="detail-section">
                ...
                <?php if (!empty($display_documents)): ?>
                    <div style="margin-bottom: 30px;">
                        <h3 style="color: #495057; font-size: 18px; margin-bottom: 20px;"><i class="fas fa-check-circle"
                                style="color: #28a745;"></i> Uploaded Documents</h3>
                                ...
                                <div class="document-card">
                                    <div style="display: flex; gap: 15px; align-items: center;">
                                        ...
                                        <div class="document-info">
                                            <h4><?php echo htmlspecialchars(ucfirst(str_replace('_', ' ', $doc['document_type']))); ?>
                                            </h4>
                                            <div class="document-meta">
                                                <?php echo $doc['uploaded_date_formatted']; ?>
                                    ...
                                    <div class="document-actions">
                                        <a href="<?php echo htmlspecialchars($doc['file_url']); ?>" target="_blank"
                                            class="btn btn-primary" style="padding: 8px; justify-content: center;">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <button onclick="showUploadForm('<?php echo $doc['document_type']; ?>')"
                                            class="btn btn-secondary" style="padding: 8px; justify-content: center;">
                ...
                <?php if (!empty($missing_documents)): ?>
                    <div style="margin-bottom: 35px;">
                        <h3 style="color: #495057; font-size: 18px; margin-bottom: 20px;"><i
                                class="fas fa-exclamation-circle" style="color: #ffc107;"></i> Missing Documents</h3>
                        <div class="document-grid">
                            <?php foreach ($missing_documents as $doc_type => $doc_name): ?>
                                <div class="missing-doc-card">
                                    <div style="font-size: 24px; color: #a0aec0; margin-bottom: 15px;">
                                        <i class="fas fa-cloud-upload-alt"></i>
                                    </div>
                                    <div style="font-weight: 700; color: #4a5568; margin-bottom: 15px; font-size: 15px;">
                                        <?php echo htmlspecialchars($doc_name); ?>
                                    </div>
                                    <button onclick="showUploadForm('<?php echo $doc_type; ?>')" class="btn btn-primary"
                ...
                <div style="margin-top: 40px; padding-top: 30px; border-top: 1px solid #edf2f7;">
                    <h3 style="color: #495057; font-size: 18px; margin-bottom: 20px;"><i class="fas fa-folder-plus"></i>
                        Quick Upload Other Documents</h3>
                    <div class="other-docs-grid">
                        <?php foreach ($all_document_types as $doc_type => $doc_name): ?>
                            <?php if (!isset($existing_documents[$doc_type]) && !in_array($doc_type, ['aadhaar', 'pan'])): ?>
                                <button onclick="showUploadForm('<?php echo $doc_type; ?>')" class="btn-mini-upload">
                                    <i class="fas fa-plus"></i> <?php echo htmlspecialchars($doc_name); ?>
                                </button>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
            ...
            <div id="uploadDocumentModal" class="modal" style="display: none;">
                <div class="modal-content" style="max-width: 500px;">
                    ...
                    <form method="POST" action="student-details.php" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="file" id="upload_document_file" name="document_file" required
                                    accept="image/*,.pdf" onchange="previewUploadFile(this)">
                        ...
                        <div class="form-actions"
                            style="display: flex; gap: 10px; justify-content: flex-end; padding: 20px; border-top: 1px solid #e9ecef;">
